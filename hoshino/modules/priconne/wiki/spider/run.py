...
start = datetime.now()
path = 'C:\\Users\cwx_x\Documents\workSpace\python\prc_chara_spider\chromedriver.exe'#此处更改为你存放chromedriver的地址
opt = Options()
opt.add_argument('--headless')
opt.add_argument('--disk-cache-dir=C:\\Users\cwx_x\Documents\workSpace\python\prc_chara_spider\cache')#此处更改为你想存放缓存的地址
