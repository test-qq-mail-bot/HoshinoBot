...
CHARA_NAME = {
    ...
    1110: ["优妮", "ユニ", "Yuni", "u2", "优妮辈先", "辈先", "书记", "uni"],
    ...
    1131: ["流夏(夏日)", "ルカ(サマー)", "Ruka(Summer)", "泳装流夏", "水流夏", "泳装大姐", "泳装大姐头"],
    1132: ["杏奈(夏日)", "アンナ(サマー)", "Anna(Summer)", "水中二", "泳装中二"],
    1133: ["七七香(夏日)", "ナナカ(サマー)", "Nanaka(Summer)", "水娜娜卡", "水77k", "水77香", "水七七香", "泳装娜娜卡", "泳装77k", "泳装77香", "泳装七七香"],
    1134: ["初音(夏日)", "ハツネ(サマー)", "Hatsune(Summer)", "水星法", "水星星法", "水⭐法", "水睡法","泳装星法", "泳装星星法", "泳装⭐法", "泳装睡法", "水初音", "泳装初音"],
    1135: ["美里(夏日)", "ミサト(サマー)", "Misato(Summer)", "水圣母", "泳装圣母", "水美里", "泳装美里"],
