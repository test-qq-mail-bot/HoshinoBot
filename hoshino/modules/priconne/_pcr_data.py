...
CHARA_NAME = {
    ...
    1076: ["可可萝(夏日)", "コッコロ(サマー)", "Kokkoro(Summer)", "水白", "水可", "水妈","水可可", "水可可萝", "水可可罗", "泳装可可萝", "泳装可可罗"],
    ...
    1127: ["铃(游侠)", "リン(レンジャー)", "Rin(Ranger)", "骑兵松鼠", "游侠松鼠", "游骑兵松鼠", "护林员松鼠", "护林松鼠", "游侠🐿️", "武松","铃(游骑兵)"],
    1128: ["真阳(游侠)", "マヒル(レンジャー)", "Mahiru(Ranger)", "骑兵奶牛", "游侠奶牛", "游骑兵奶牛", "护林员奶牛", "护林奶牛", "游侠🐄", "游侠🐮","真阳(游骑兵)"],
    ...
    1131: ["流夏(夏日)", "ルカ(サマー)", "Ruka(Summer)", "水流夏", "水大姐头", "水大姐", "泳装大姐头", "泳装流夏", "流夏(泳装)","水亚索","泳装亚索","亚索"],
    1132: ["杏奈(夏日)", "アンナ(サマー)", "Anna(Summer)", "水中二", "泳装中二", "冲二", "喷水龙王"],
    1133: ["七七香(夏日)", "ナナカ(サマー)", "Nanaka(Summer)", "水七七香", "泳装七七香", "泳装眼镜", "水眼镜"],
    1134: ["初音(夏日)","ハツネ(サマー)","Hatsune(Summer)","水初音","水星法","海星","水星","泳装星法","泳装初音"],
    1135: ["美里(夏日)","ミサト(サマー)","Misato(Summer)", "水圣母","水母","水美里","泳装圣母","泳装美里"],
    1136: ["纯(夏日)","ジュン(サマー)","Jun(Summer)","水纯","泳装纯","水黑骑","泳装黑骑","小次郎","潶骑"],
    1137: ["茜里(天使)", "アカリ(エンジェル)", "Akari(angel)", "天使妹法", "天使妹妹法"],
    1138: ["依里(天使)", "ヨリ(エンジェル)", "Yori(angel)", "天使姐法", "天使姐姐法"],
    1139: ["纺希(万圣节)", "ツムギ(ハロウィン)", "Tsumugi(Halloween)", "万圣裁缝", "万圣蜘蛛侠", "🎃🕷️", "🎃🕸️", "万裁", "瓜裁", "鬼裁", "鬼才"],
    1140: ["怜(万圣节)", "レイ(ハロウィン)", "Rei(Halloween)", "万圣剑圣", "万剑", "瓜剑"],
