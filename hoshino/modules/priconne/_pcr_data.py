...
CHARA_NAME = {
    ...
    1036: ["镜华", "キョウカ", "Kyouka", "小仓唯", "xcw", "小苍唯", "8岁", "八岁", "喷水萝", "喷水萝莉", "八岁喷水萝", "8岁喷水萝"],
    1037: ["智", "トモ", "Tomo", "卜毛"],
    ...
    1134: ["初音(夏日)", "ハツネ(サマー)", "Hatsune(Summer)", "水星", "海星", "水hego", "水星法", "泳装星法", "⭐法", "水睡法", "湦"],
    ...
    1802: ["优衣(公主)", "ユイ(プリンセス)", "Yui(Princess)", "公主种田", "公主优衣", "公主由衣", "公主结衣", "公主ue"],
    1131: ["流夏(夏日)", "ルカ(サマー)", "Ruka(Summer)", "水流夏", "水大姐头", "水大姐", "泳装大姐头", "泳装流夏", "流夏(泳装)"],
    1132: ["杏奈(夏日)", "アンナ(サマー)", "Anna(Summer)", "水中二", "泳装中二", "冲二", "喷水龙王"],
    1133: ["七七香(夏日)", "ナナカ(サマー)", "Nanaka(Summer)", "水七七香", "泳装七七香", "泳装眼镜", "水眼镜"],
    1134: ["初音(夏日)", "ハツネ(サマー)", "Hatsune(Summer)", "水初音", "泳装初音", "水星法", "水星星法", "泳装星法"],
    1135: ["美里(夏日)", "ミサト(サマー)", "Misato(Summer)", "水母", "水圣母"],    
